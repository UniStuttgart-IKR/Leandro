...
**A first slice exists** (`scripts/ioctl-matrix.sh verify`, `matrix/verified-610.57.04.json`): 202 signature(s) had the first
...
declared. 47 of them are `implemented-verified`.
