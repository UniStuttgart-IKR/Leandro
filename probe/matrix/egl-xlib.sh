...
#
# matrix-group:     egl
# matrix-libs:      libEGL_nvidia libnvidia-eglcore libnvidia-egl-xlib libnvidia-glsi libnvidia-tls libnvidia-glvkspirv
# matrix-entry:     eglGetPlatformDisplayEXT(xlib) + pbuffer + GLES2
...
lea_matrix_criterion "EGL/xlib: vendor $vendor, pbuffer pixel read back as $px"
